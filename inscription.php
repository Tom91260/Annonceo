<?php
	...
	<form id="inscription" action="" method="post">
        <div class="form-group <?= isset($errorInscription['pseudo']) ? 'has-error' : '' ?>">
            ...
            <input type="text" class="form-control" id="pseudo" name="pseudo" placeholder="saisissez votre pseudo" 
            value="<?= $_POST['pseudo'] ?? '' ?>">
            <?= $errorInscription['pseudo'] ?? '' ?>
        </div>
        <div class="form-group <?= isset($errorInscription['prenom']) ? 'has-error' : '' ?>">
            <label for="prenom">Prenom</label>
            <input type="text" class="form-control" id="prenom" name="prenom" placeholder="saisissez votre prenom" 
            value="<?= $_POST['prenom'] ?? '' ?>">
        ...
        <label>Civilité</label>
            <div class="radio">
                <label>
                    ...
                    checked <?php if(!empty($_POST['civilite']) && $_POST['civilite'] == "f"){ echo 'checked';} else { echo '';} ?> />
                Femme
                </label>
                </div>
                <div class="radio">
                <label>
                    ...
                    value="m" <?php if(!empty($_POST['civilite']) && $_POST['civilite'] == "m"){ echo 'checked';} else { echo '';} ?> />
                Homme
                </label>
        ...
        <div class="form-group <?= isset($errorInscription['telephone']) ? 'has-error' : '' ?>">
            ...
            placeholder="saisissez votre telephone" value="<?= $_POST['telephone'] ?? '' ?>">
